...
class Touch:
    ...
    Touch events are debounced by TOUCH_INTERVAL seconds. Each event that
    passes the debounce filter is forwarded directly to
    manager.touch_trigger.trigger(x, y).
    """
